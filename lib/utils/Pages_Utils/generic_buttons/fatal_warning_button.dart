...
class MyButton_FatalWarning extends StatefulWidget {
  ...
  @override
  State<MyButton_FatalWarning> createState() => _MyButton_FatalWarningState();
}

class _MyButton_FatalWarningState extends State<MyButton_FatalWarning> {
  @override
